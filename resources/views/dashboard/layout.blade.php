...
<head>
  ...
  <!-- plugins:css -->
  <link rel="stylesheet" href="{{asset('admin')}}/endors/mdi/css/materialdesignicons.min.css">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">  
          <a class="navbar-brand brand-logo" style="width:100%" href="index.html"><img src="{{asset('admin')}}/images/logo-moon.jpg" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{asset('admin')}}/images/logo-moon.jpg" alt="logo"/></a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="d-sm-flex justify-content-center justify-content-sm-between">
          <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © Kamarajendra MJ 2023</span>
          <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Me the best Kamarajendra</span>
        </div>
        </footer>
        <!-- partial -->
      </div>
